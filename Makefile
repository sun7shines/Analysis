...
am__append_2 =  \
	...
	extras/iosched/80-iosched.rules \
	extras/iosched/80-mpath-iosched.rules
am__append_3 = extras/gudev/docs
am__append_4 = extras/gudev/libgudev-1.0.la
am__append_5 = extras/gudev/gudev-1.0.pc

# ------------------------------------------------------------------------------
# iosched - optimize I/O scheduler tunings
# ------------------------------------------------------------------------------
am__append_6 = extras/gudev/gudevmarshal.list \
	extras/gudev/gudevenumtypes.h.template \
	extras/gudev/gudevenumtypes.c.template \
	extras/keymap/check-keymaps.sh \
	extras/iosched/80-iosched.rules \
	extras/iosched/80-mpath-iosched.rules \
	extras/iosched/mpath-iosched.sh
#am__append_7 = $(gir_DATA) $(typelibs_DATA)
am__append_8 = extras/hid2hci/hid2hci \
	extras/udev-acl/udev-acl \
	extras/usb-db/usb-db extras/usb-db/pci-db \
	extras/modem-modeswitch/modem-modeswitch \
	extras/keymap/keymap
am__append_9 = udevacl-install-hook
am__append_10 = extras/keymap/findkeyboards \
...
DIST_COMMON = README $(am__configure_deps) $(am__dist_doc_DATA_DIST) \
	...
	$(dist_udevconf_DATA) $(dist_udevhome_DATA) \
	$(dist_writing_udev_rules_DATA) $(include_HEADERS) \
...
CONFIG_CLEAN_FILES = libudev/libudev.pc udev/udev.pc \
...
am__installdirs = "$(DESTDIR)$(libdir)" "$(DESTDIR)$(libexecdir)" \
	...
	"$(DESTDIR)$(writing_udev_rulesdir)" "$(DESTDIR)$(girdir)" \
	"$(DESTDIR)$(pkgconfigdir)" "$(DESTDIR)$(sharepkgconfigdir)" \
	"$(DESTDIR)$(typelibsdir)" "$(DESTDIR)$(includedir)" \
	"$(DESTDIR)$(libgudev_includedir)"
LTLIBRARIES = $(lib_LTLIBRARIES) $(noinst_LTLIBRARIES)
am__DEPENDENCIES_1 =
extras_gudev_libgudev_1_0_la_DEPENDENCIES =  \
	libudev/libudev.la $(am__DEPENDENCIES_1)
am__extras_gudev_libgudev_1_0_la_SOURCES_DIST =  \
	...
	extras/gudev/gudevdevice.c extras/gudev/gudevprivate.h
am__dirstamp = $(am__leading_dot)dirstamp
am_extras_gudev_libgudev_1_0_la_OBJECTS = extras/gudev/extras_gudev_libgudev_1_0_la-gudevclient.lo \
...
dist_extras_gudev_libgudev_1_0_la_OBJECTS = extras/gudev/extras_gudev_libgudev_1_0_la-gudevmarshal.lo \
...
am_extras_gudev_libgudev_1_0_la_rpath = -rpath \
	$(libdir)
libudev_libudev_private_la_DEPENDENCIES =  \
	$(am__DEPENDENCIES_1)
...
am__objects_2 = libudev/libudev-selinux-private.lo
...
libudev_libudev_la_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC \
	...
	$(LDFLAGS) -o $@
am__EXEEXT_1 = extras/hid2hci/hid2hci$(EXEEXT) \
	extras/udev-acl/udev-acl$(EXEEXT) \
	extras/usb-db/usb-db$(EXEEXT) \
	extras/usb-db/pci-db$(EXEEXT) \
	extras/modem-modeswitch/modem-modeswitch$(EXEEXT) \
	extras/keymap/keymap$(EXEEXT)
...
am_extras_hid2hci_hid2hci_OBJECTS = extras/hid2hci/extras_hid2hci_hid2hci-hid2hci.$(OBJEXT)
...
am_extras_keymap_keymap_OBJECTS = extras/keymap/extras_keymap_keymap-keymap.$(OBJEXT)
...
am__extras_modem_modeswitch_modem_modeswitch_SOURCES_DIST =  \
...
am_extras_modem_modeswitch_modem_modeswitch_OBJECTS = extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-modem-modeswitch.$(OBJEXT) \
	extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-utils.$(OBJEXT) \
	extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-ma8280p_us.$(OBJEXT) \
	extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-option.$(OBJEXT)
extras_modem_modeswitch_modem_modeswitch_OBJECTS =  \
	$(am_extras_modem_modeswitch_modem_modeswitch_OBJECTS)
extras_modem_modeswitch_modem_modeswitch_DEPENDENCIES =  \
	libudev/libudev-private.la \
	$(am__DEPENDENCIES_1)
...
am_extras_udev_acl_udev_acl_OBJECTS = extras/udev-acl/extras_udev_acl_udev_acl-udev-acl.$(OBJEXT)
extras_udev_acl_udev_acl_OBJECTS =  \
	$(am_extras_udev_acl_udev_acl_OBJECTS)
extras_udev_acl_udev_acl_DEPENDENCIES =  \
	libudev/libudev-private.la \
	$(am__DEPENDENCIES_1)
am__extras_usb_db_pci_db_SOURCES_DIST = extras/usb-db/usb-db.c
am_extras_usb_db_pci_db_OBJECTS = extras/usb-db/extras_usb_db_pci_db-usb-db.$(OBJEXT)
extras_usb_db_pci_db_OBJECTS = $(am_extras_usb_db_pci_db_OBJECTS)
extras_usb_db_pci_db_DEPENDENCIES =  \
	libudev/libudev-private.la
am__extras_usb_db_usb_db_SOURCES_DIST = extras/usb-db/usb-db.c
am_extras_usb_db_usb_db_OBJECTS = extras/usb-db/extras_usb_db_usb_db-usb-db.$(OBJEXT)
extras_usb_db_usb_db_OBJECTS = $(am_extras_usb_db_usb_db_OBJECTS)
extras_usb_db_usb_db_DEPENDENCIES =  \
	libudev/libudev-private.la
...
am__dist_libexec_SCRIPTS_DIST = extras/firmware/firmware.sh \
...
am__dist_udevrules_DATA_DIST = rules/rules.d/50-udev-default.rules \
	...
	extras/iosched/80-iosched.rules \
	extras/iosched/80-mpath-iosched.rules
DATA = $(dist_doc_DATA) $(dist_udevconf_DATA) $(dist_udevhome_DATA) \
	$(dist_udevkeymap_DATA) $(dist_udevkeymapforcerel_DATA) \
	$(dist_udevrules_DATA) $(dist_writing_udev_rules_DATA) \
...
ACLOCAL = ${SHELL} /root/rpmbuild/BUILD/udev-147/missing --run aclocal-1.11
AMTAR = ${SHELL} /root/rpmbuild/BUILD/udev-147/missing --run tar
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /root/rpmbuild/BUILD/udev-147/missing --run autoconf
AUTOHEADER = ${SHELL} /root/rpmbuild/BUILD/udev-147/missing --run autoheader
AUTOMAKE = ${SHELL} /root/rpmbuild/BUILD/udev-147/missing --run automake-1.11
AWK = gawk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS =  -O2 -g -pipe -fdump-rtl-expand -Wall -Wp,-D_FORTIFY_SOURCE=2 -fexceptions -fstack-protector --param=ssp-buffer-size=4 -m64 -mtune=generic -fPIE -DPIE
CPP = gcc -E
CPPFLAGS = 
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
...
LDFLAGS =  -O2 -g -pipe -fdump-rtl-expand -Wall -Wp,-D_FORTIFY_SOURCE=2 -fexceptions -fstack-protector --param=ssp-buffer-size=4 -m64 -mtune=generic -pie -Wl,-z,relro -Wl,-z,now
LIBOBJS = 
LIBS = 
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /root/rpmbuild/BUILD/udev-147/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
OBJDUMP = objdump
...
abs_builddir = /root/rpmbuild/BUILD/udev-147
abs_srcdir = /root/rpmbuild/BUILD/udev-147
abs_top_builddir = /root/rpmbuild/BUILD/udev-147
abs_top_srcdir = /root/rpmbuild/BUILD/udev-147
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /root/rpmbuild/BUILD/udev-147/install-sh
libdir = /usr/lib64
libexecdir = /lib/udev
...
EXTRA_DIST = autogen.sh libudev/exported_symbols rules/packages \
	rules/redhat rules/suse rules/gentoo udev/udev.xml \
	udev/udevadm.xml udev/udevd.xml $(am__append_6) $(TESTS)
...
CLEANFILES = $(am__append_7) $(am__append_11) udev-$(VERSION).tar.gz \
...
dist_udevrules_DATA = rules/rules.d/50-udev-default.rules \
	...
	extras/edd_id/61-persistent-storage-edd.rules \
	extras/fstab_import/79-fstab_import.rules \
	extras/v4l_id/60-persistent-v4l.rules $(am__append_2)
...
dist_libexec_SCRIPTS = extras/firmware/firmware.sh \
	extras/rule_generator/write_cd_rules \
	extras/rule_generator/write_net_rules $(am__append_10)
...
extras/modem-modeswitch/$(am__dirstamp):
	@$(MKDIR_P) extras/modem-modeswitch
	@: > extras/modem-modeswitch/$(am__dirstamp)
extras/modem-modeswitch/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) extras/modem-modeswitch/$(DEPDIR)
	@: > extras/modem-modeswitch/$(DEPDIR)/$(am__dirstamp)
extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-modem-modeswitch.$(OBJEXT):  \
	extras/modem-modeswitch/$(am__dirstamp) \
	extras/modem-modeswitch/$(DEPDIR)/$(am__dirstamp)
extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-utils.$(OBJEXT):  \
	extras/modem-modeswitch/$(am__dirstamp) \
...
extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-option.$(OBJEXT):  \
	extras/modem-modeswitch/$(am__dirstamp) \
	extras/modem-modeswitch/$(DEPDIR)/$(am__dirstamp)
extras/modem-modeswitch/modem-modeswitch$(EXEEXT): $(extras_modem_modeswitch_modem_modeswitch_OBJECTS) $(extras_modem_modeswitch_modem_modeswitch_DEPENDENCIES) extras/modem-modeswitch/$(am__dirstamp)
	@rm -f extras/modem-modeswitch/modem-modeswitch$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(extras_modem_modeswitch_modem_modeswitch_OBJECTS) $(extras_modem_modeswitch_modem_modeswitch_LDADD) $(LIBS)
...
udev/udev-rules.$(OBJEXT): udev/$(am__dirstamp) \
	udev/$(DEPDIR)/$(am__dirstamp)
udev/udev-lock.$(OBJEXT): udev/$(am__dirstamp) \
	udev/$(DEPDIR)/$(am__dirstamp)
...
mostlyclean-compile:
	...
	-rm -f extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-ma8280p_us.$(OBJEXT)
	-rm -f extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-modem-modeswitch.$(OBJEXT)
	-rm -f extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-option.$(OBJEXT)
	-rm -f extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-utils.$(OBJEXT)
...
include extras/ata_id/$(DEPDIR)/ata_id.Po
include extras/cdrom_id/$(DEPDIR)/cdrom_id.Po
include extras/collect/$(DEPDIR)/collect.Po
include extras/edd_id/$(DEPDIR)/edd_id.Po
include extras/floppy/$(DEPDIR)/create_floppy_devices.Po
include extras/fstab_import/$(DEPDIR)/fstab_import.Po
include extras/gudev/$(DEPDIR)/extras_gudev_libgudev_1_0_la-gudevclient.Plo
include extras/gudev/$(DEPDIR)/extras_gudev_libgudev_1_0_la-gudevdevice.Plo
include extras/gudev/$(DEPDIR)/extras_gudev_libgudev_1_0_la-gudevenumtypes.Plo
include extras/gudev/$(DEPDIR)/extras_gudev_libgudev_1_0_la-gudevmarshal.Plo
include extras/hid2hci/$(DEPDIR)/extras_hid2hci_hid2hci-hid2hci.Po
include extras/keymap/$(DEPDIR)/extras_keymap_keymap-keymap.Po
include extras/modem-modeswitch/$(DEPDIR)/extras_modem_modeswitch_modem_modeswitch-ma8280p_us.Po
include extras/modem-modeswitch/$(DEPDIR)/extras_modem_modeswitch_modem_modeswitch-modem-modeswitch.Po
include extras/modem-modeswitch/$(DEPDIR)/extras_modem_modeswitch_modem_modeswitch-option.Po
include extras/modem-modeswitch/$(DEPDIR)/extras_modem_modeswitch_modem_modeswitch-utils.Po
include extras/path_id/$(DEPDIR)/path_id.Po
include extras/scsi_id/$(DEPDIR)/scsi_id.Po
include extras/scsi_id/$(DEPDIR)/scsi_serial.Po
include extras/udev-acl/$(DEPDIR)/extras_udev_acl_udev_acl-udev-acl.Po
include extras/usb-db/$(DEPDIR)/extras_usb_db_pci_db-usb-db.Po
include extras/usb-db/$(DEPDIR)/extras_usb_db_usb_db-usb-db.Po
include extras/usb_id/$(DEPDIR)/usb_id.Po
include extras/v4l_id/$(DEPDIR)/v4l_id.Po
include libudev/$(DEPDIR)/libudev-ctrl.Plo
include libudev/$(DEPDIR)/libudev-device-private.Plo
include libudev/$(DEPDIR)/libudev-device.Plo
include libudev/$(DEPDIR)/libudev-enumerate.Plo
include libudev/$(DEPDIR)/libudev-list.Plo
include libudev/$(DEPDIR)/libudev-monitor.Plo
include libudev/$(DEPDIR)/libudev-queue-private.Plo
include libudev/$(DEPDIR)/libudev-queue.Plo
include libudev/$(DEPDIR)/libudev-selinux-private.Plo
include libudev/$(DEPDIR)/libudev-util-private.Plo
include libudev/$(DEPDIR)/libudev-util.Plo
include libudev/$(DEPDIR)/libudev.Plo
include libudev/$(DEPDIR)/test-libudev.Po
include udev/$(DEPDIR)/test-udev.Po
include udev/$(DEPDIR)/udev-event.Po
include udev/$(DEPDIR)/udev-lock.Po
include udev/$(DEPDIR)/udev-node.Po
include udev/$(DEPDIR)/udev-rules.Po
include udev/$(DEPDIR)/udev-watch.Po
include udev/$(DEPDIR)/udevadm-control.Po
include udev/$(DEPDIR)/udevadm-info.Po
include udev/$(DEPDIR)/udevadm-monitor.Po
include udev/$(DEPDIR)/udevadm-settle.Po
include udev/$(DEPDIR)/udevadm-test.Po
include udev/$(DEPDIR)/udevadm-trigger.Po
include udev/$(DEPDIR)/udevadm.Po
include udev/$(DEPDIR)/udevd.Po
...
extras/gudev/extras_gudev_libgudev_1_0_la-gudevclient.lo: extras/gudev/gudevclient.c
	...
	$(AM_V_at)$(am__mv) extras/gudev/$(DEPDIR)/extras_gudev_libgudev_1_0_la-gudevclient.Tpo extras/gudev/$(DEPDIR)/extras_gudev_libgudev_1_0_la-gudevclient.Plo
#	$(AM_V_CC) \
#	source='extras/gudev/gudevclient.c' object='extras/gudev/extras_gudev_libgudev_1_0_la-gudevclient.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
...
extras/gudev/extras_gudev_libgudev_1_0_la-gudevdevice.lo: extras/gudev/gudevdevice.c
	...
	$(AM_V_at)$(am__mv) extras/gudev/$(DEPDIR)/extras_gudev_libgudev_1_0_la-gudevdevice.Tpo extras/gudev/$(DEPDIR)/extras_gudev_libgudev_1_0_la-gudevdevice.Plo
#	$(AM_V_CC) \
#	source='extras/gudev/gudevdevice.c' object='extras/gudev/extras_gudev_libgudev_1_0_la-gudevdevice.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(extras_gudev_libgudev_1_0_la_CPPFLAGS) $(CPPFLAGS) $(extras_gudev_libgudev_1_0_la_CFLAGS) $(CFLAGS) -c -o extras/gudev/extras_gudev_libgudev_1_0_la-gudevdevice.lo `test -f 'extras/gudev/gudevdevice.c' || echo '$(srcdir)/'`extras/gudev/gudevdevice.c
...
extras/gudev/extras_gudev_libgudev_1_0_la-gudevmarshal.lo: extras/gudev/gudevmarshal.c
	...
	$(AM_V_at)$(am__mv) extras/gudev/$(DEPDIR)/extras_gudev_libgudev_1_0_la-gudevmarshal.Tpo extras/gudev/$(DEPDIR)/extras_gudev_libgudev_1_0_la-gudevmarshal.Plo
#	$(AM_V_CC) \
#	source='extras/gudev/gudevmarshal.c' object='extras/gudev/extras_gudev_libgudev_1_0_la-gudevmarshal.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(extras_gudev_libgudev_1_0_la_CPPFLAGS) $(CPPFLAGS) $(extras_gudev_libgudev_1_0_la_CFLAGS) $(CFLAGS) -c -o extras/gudev/extras_gudev_libgudev_1_0_la-gudevmarshal.lo `test -f 'extras/gudev/gudevmarshal.c' || echo '$(srcdir)/'`extras/gudev/gudevmarshal.c
...
extras/gudev/extras_gudev_libgudev_1_0_la-gudevenumtypes.lo: extras/gudev/gudevenumtypes.c
	...
	$(AM_V_at)$(am__mv) extras/gudev/$(DEPDIR)/extras_gudev_libgudev_1_0_la-gudevenumtypes.Tpo extras/gudev/$(DEPDIR)/extras_gudev_libgudev_1_0_la-gudevenumtypes.Plo
#	$(AM_V_CC) \
#	source='extras/gudev/gudevenumtypes.c' object='extras/gudev/extras_gudev_libgudev_1_0_la-gudevenumtypes.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(extras_gudev_libgudev_1_0_la_CPPFLAGS) $(CPPFLAGS) $(extras_gudev_libgudev_1_0_la_CFLAGS) $(CFLAGS) -c -o extras/gudev/extras_gudev_libgudev_1_0_la-gudevenumtypes.lo `test -f 'extras/gudev/gudevenumtypes.c' || echo '$(srcdir)/'`extras/gudev/gudevenumtypes.c
...
extras/hid2hci/extras_hid2hci_hid2hci-hid2hci.o: extras/hid2hci/hid2hci.c
	...
	$(AM_V_at)$(am__mv) extras/hid2hci/$(DEPDIR)/extras_hid2hci_hid2hci-hid2hci.Tpo extras/hid2hci/$(DEPDIR)/extras_hid2hci_hid2hci-hid2hci.Po
#	$(AM_V_CC) \
#	source='extras/hid2hci/hid2hci.c' object='extras/hid2hci/extras_hid2hci_hid2hci-hid2hci.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(extras_hid2hci_hid2hci_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o extras/hid2hci/extras_hid2hci_hid2hci-hid2hci.o `test -f 'extras/hid2hci/hid2hci.c' || echo '$(srcdir)/'`extras/hid2hci/hid2hci.c
...
extras/hid2hci/extras_hid2hci_hid2hci-hid2hci.obj: extras/hid2hci/hid2hci.c
	...
	$(AM_V_at)$(am__mv) extras/hid2hci/$(DEPDIR)/extras_hid2hci_hid2hci-hid2hci.Tpo extras/hid2hci/$(DEPDIR)/extras_hid2hci_hid2hci-hid2hci.Po
#	$(AM_V_CC) \
#	source='extras/hid2hci/hid2hci.c' object='extras/hid2hci/extras_hid2hci_hid2hci-hid2hci.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(extras_hid2hci_hid2hci_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o extras/hid2hci/extras_hid2hci_hid2hci-hid2hci.obj `if test -f 'extras/hid2hci/hid2hci.c'; then $(CYGPATH_W) 'extras/hid2hci/hid2hci.c'; else $(CYGPATH_W) '$(srcdir)/extras/hid2hci/hid2hci.c'; fi`
...
extras/keymap/extras_keymap_keymap-keymap.o: extras/keymap/keymap.c
	...
	$(AM_V_at)$(am__mv) extras/keymap/$(DEPDIR)/extras_keymap_keymap-keymap.Tpo extras/keymap/$(DEPDIR)/extras_keymap_keymap-keymap.Po
#	$(AM_V_CC) \
#	source='extras/keymap/keymap.c' object='extras/keymap/extras_keymap_keymap-keymap.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(extras_keymap_keymap_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o extras/keymap/extras_keymap_keymap-keymap.o `test -f 'extras/keymap/keymap.c' || echo '$(srcdir)/'`extras/keymap/keymap.c
...
extras/keymap/extras_keymap_keymap-keymap.obj: extras/keymap/keymap.c
	...
	$(AM_V_at)$(am__mv) extras/keymap/$(DEPDIR)/extras_keymap_keymap-keymap.Tpo extras/keymap/$(DEPDIR)/extras_keymap_keymap-keymap.Po
#	$(AM_V_CC) \
#	source='extras/keymap/keymap.c' object='extras/keymap/extras_keymap_keymap-keymap.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(extras_keymap_keymap_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o extras/keymap/extras_keymap_keymap-keymap.obj `if test -f 'extras/keymap/keymap.c'; then $(CYGPATH_W) 'extras/keymap/keymap.c'; else $(CYGPATH_W) '$(srcdir)/extras/keymap/keymap.c'; fi`

extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-modem-modeswitch.o: extras/modem-modeswitch/modem-modeswitch.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(extras_modem_modeswitch_modem_modeswitch_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-modem-modeswitch.o -MD -MP -MF extras/modem-modeswitch/$(DEPDIR)/extras_modem_modeswitch_modem_modeswitch-modem-modeswitch.Tpo -c -o extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-modem-modeswitch.o `test -f 'extras/modem-modeswitch/modem-modeswitch.c' || echo '$(srcdir)/'`extras/modem-modeswitch/modem-modeswitch.c
	$(AM_V_at)$(am__mv) extras/modem-modeswitch/$(DEPDIR)/extras_modem_modeswitch_modem_modeswitch-modem-modeswitch.Tpo extras/modem-modeswitch/$(DEPDIR)/extras_modem_modeswitch_modem_modeswitch-modem-modeswitch.Po
#	$(AM_V_CC) \
#	source='extras/modem-modeswitch/modem-modeswitch.c' object='extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-modem-modeswitch.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(extras_modem_modeswitch_modem_modeswitch_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-modem-modeswitch.o `test -f 'extras/modem-modeswitch/modem-modeswitch.c' || echo '$(srcdir)/'`extras/modem-modeswitch/modem-modeswitch.c

extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-modem-modeswitch.obj: extras/modem-modeswitch/modem-modeswitch.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(extras_modem_modeswitch_modem_modeswitch_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-modem-modeswitch.obj -MD -MP -MF extras/modem-modeswitch/$(DEPDIR)/extras_modem_modeswitch_modem_modeswitch-modem-modeswitch.Tpo -c -o extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-modem-modeswitch.obj `if test -f 'extras/modem-modeswitch/modem-modeswitch.c'; then $(CYGPATH_W) 'extras/modem-modeswitch/modem-modeswitch.c'; else $(CYGPATH_W) '$(srcdir)/extras/modem-modeswitch/modem-modeswitch.c'; fi`
	$(AM_V_at)$(am__mv) extras/modem-modeswitch/$(DEPDIR)/extras_modem_modeswitch_modem_modeswitch-modem-modeswitch.Tpo extras/modem-modeswitch/$(DEPDIR)/extras_modem_modeswitch_modem_modeswitch-modem-modeswitch.Po
#	$(AM_V_CC) \
#	source='extras/modem-modeswitch/modem-modeswitch.c' object='extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-modem-modeswitch.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(extras_modem_modeswitch_modem_modeswitch_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-modem-modeswitch.obj `if test -f 'extras/modem-modeswitch/modem-modeswitch.c'; then $(CYGPATH_W) 'extras/modem-modeswitch/modem-modeswitch.c'; else $(CYGPATH_W) '$(srcdir)/extras/modem-modeswitch/modem-modeswitch.c'; fi`

extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-utils.o: extras/modem-modeswitch/utils.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(extras_modem_modeswitch_modem_modeswitch_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-utils.o -MD -MP -MF extras/modem-modeswitch/$(DEPDIR)/extras_modem_modeswitch_modem_modeswitch-utils.Tpo -c -o extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-utils.o `test -f 'extras/modem-modeswitch/utils.c' || echo '$(srcdir)/'`extras/modem-modeswitch/utils.c
	$(AM_V_at)$(am__mv) extras/modem-modeswitch/$(DEPDIR)/extras_modem_modeswitch_modem_modeswitch-utils.Tpo extras/modem-modeswitch/$(DEPDIR)/extras_modem_modeswitch_modem_modeswitch-utils.Po
#	$(AM_V_CC) \
#	source='extras/modem-modeswitch/utils.c' object='extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-utils.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(extras_modem_modeswitch_modem_modeswitch_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-utils.o `test -f 'extras/modem-modeswitch/utils.c' || echo '$(srcdir)/'`extras/modem-modeswitch/utils.c

extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-utils.obj: extras/modem-modeswitch/utils.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(extras_modem_modeswitch_modem_modeswitch_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-utils.obj -MD -MP -MF extras/modem-modeswitch/$(DEPDIR)/extras_modem_modeswitch_modem_modeswitch-utils.Tpo -c -o extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-utils.obj `if test -f 'extras/modem-modeswitch/utils.c'; then $(CYGPATH_W) 'extras/modem-modeswitch/utils.c'; else $(CYGPATH_W) '$(srcdir)/extras/modem-modeswitch/utils.c'; fi`
	$(AM_V_at)$(am__mv) extras/modem-modeswitch/$(DEPDIR)/extras_modem_modeswitch_modem_modeswitch-utils.Tpo extras/modem-modeswitch/$(DEPDIR)/extras_modem_modeswitch_modem_modeswitch-utils.Po
#	$(AM_V_CC) \
#	source='extras/modem-modeswitch/utils.c' object='extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-utils.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(extras_modem_modeswitch_modem_modeswitch_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-utils.obj `if test -f 'extras/modem-modeswitch/utils.c'; then $(CYGPATH_W) 'extras/modem-modeswitch/utils.c'; else $(CYGPATH_W) '$(srcdir)/extras/modem-modeswitch/utils.c'; fi`

extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-ma8280p_us.o: extras/modem-modeswitch/ma8280p_us.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(extras_modem_modeswitch_modem_modeswitch_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-ma8280p_us.o -MD -MP -MF extras/modem-modeswitch/$(DEPDIR)/extras_modem_modeswitch_modem_modeswitch-ma8280p_us.Tpo -c -o extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-ma8280p_us.o `test -f 'extras/modem-modeswitch/ma8280p_us.c' || echo '$(srcdir)/'`extras/modem-modeswitch/ma8280p_us.c
	$(AM_V_at)$(am__mv) extras/modem-modeswitch/$(DEPDIR)/extras_modem_modeswitch_modem_modeswitch-ma8280p_us.Tpo extras/modem-modeswitch/$(DEPDIR)/extras_modem_modeswitch_modem_modeswitch-ma8280p_us.Po
#	$(AM_V_CC) \
#	source='extras/modem-modeswitch/ma8280p_us.c' object='extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-ma8280p_us.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(extras_modem_modeswitch_modem_modeswitch_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-ma8280p_us.o `test -f 'extras/modem-modeswitch/ma8280p_us.c' || echo '$(srcdir)/'`extras/modem-modeswitch/ma8280p_us.c

extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-ma8280p_us.obj: extras/modem-modeswitch/ma8280p_us.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(extras_modem_modeswitch_modem_modeswitch_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-ma8280p_us.obj -MD -MP -MF extras/modem-modeswitch/$(DEPDIR)/extras_modem_modeswitch_modem_modeswitch-ma8280p_us.Tpo -c -o extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-ma8280p_us.obj `if test -f 'extras/modem-modeswitch/ma8280p_us.c'; then $(CYGPATH_W) 'extras/modem-modeswitch/ma8280p_us.c'; else $(CYGPATH_W) '$(srcdir)/extras/modem-modeswitch/ma8280p_us.c'; fi`
	$(AM_V_at)$(am__mv) extras/modem-modeswitch/$(DEPDIR)/extras_modem_modeswitch_modem_modeswitch-ma8280p_us.Tpo extras/modem-modeswitch/$(DEPDIR)/extras_modem_modeswitch_modem_modeswitch-ma8280p_us.Po
#	$(AM_V_CC) \
#	source='extras/modem-modeswitch/ma8280p_us.c' object='extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-ma8280p_us.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(extras_modem_modeswitch_modem_modeswitch_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-ma8280p_us.obj `if test -f 'extras/modem-modeswitch/ma8280p_us.c'; then $(CYGPATH_W) 'extras/modem-modeswitch/ma8280p_us.c'; else $(CYGPATH_W) '$(srcdir)/extras/modem-modeswitch/ma8280p_us.c'; fi`

extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-option.o: extras/modem-modeswitch/option.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(extras_modem_modeswitch_modem_modeswitch_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-option.o -MD -MP -MF extras/modem-modeswitch/$(DEPDIR)/extras_modem_modeswitch_modem_modeswitch-option.Tpo -c -o extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-option.o `test -f 'extras/modem-modeswitch/option.c' || echo '$(srcdir)/'`extras/modem-modeswitch/option.c
	$(AM_V_at)$(am__mv) extras/modem-modeswitch/$(DEPDIR)/extras_modem_modeswitch_modem_modeswitch-option.Tpo extras/modem-modeswitch/$(DEPDIR)/extras_modem_modeswitch_modem_modeswitch-option.Po
#	$(AM_V_CC) \
#	source='extras/modem-modeswitch/option.c' object='extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-option.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(extras_modem_modeswitch_modem_modeswitch_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-option.o `test -f 'extras/modem-modeswitch/option.c' || echo '$(srcdir)/'`extras/modem-modeswitch/option.c

extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-option.obj: extras/modem-modeswitch/option.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(extras_modem_modeswitch_modem_modeswitch_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-option.obj -MD -MP -MF extras/modem-modeswitch/$(DEPDIR)/extras_modem_modeswitch_modem_modeswitch-option.Tpo -c -o extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-option.obj `if test -f 'extras/modem-modeswitch/option.c'; then $(CYGPATH_W) 'extras/modem-modeswitch/option.c'; else $(CYGPATH_W) '$(srcdir)/extras/modem-modeswitch/option.c'; fi`
	$(AM_V_at)$(am__mv) extras/modem-modeswitch/$(DEPDIR)/extras_modem_modeswitch_modem_modeswitch-option.Tpo extras/modem-modeswitch/$(DEPDIR)/extras_modem_modeswitch_modem_modeswitch-option.Po
#	$(AM_V_CC) \
#	source='extras/modem-modeswitch/option.c' object='extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-option.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(extras_modem_modeswitch_modem_modeswitch_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o extras/modem-modeswitch/extras_modem_modeswitch_modem_modeswitch-option.obj `if test -f 'extras/modem-modeswitch/option.c'; then $(CYGPATH_W) 'extras/modem-modeswitch/option.c'; else $(CYGPATH_W) '$(srcdir)/extras/modem-modeswitch/option.c'; fi`
...
extras/udev-acl/extras_udev_acl_udev_acl-udev-acl.o: extras/udev-acl/udev-acl.c
	...
	$(AM_V_at)$(am__mv) extras/udev-acl/$(DEPDIR)/extras_udev_acl_udev_acl-udev-acl.Tpo extras/udev-acl/$(DEPDIR)/extras_udev_acl_udev_acl-udev-acl.Po
#	$(AM_V_CC) \
#	source='extras/udev-acl/udev-acl.c' object='extras/udev-acl/extras_udev_acl_udev_acl-udev-acl.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(extras_udev_acl_udev_acl_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o extras/udev-acl/extras_udev_acl_udev_acl-udev-acl.o `test -f 'extras/udev-acl/udev-acl.c' || echo '$(srcdir)/'`extras/udev-acl/udev-acl.c
...
extras/udev-acl/extras_udev_acl_udev_acl-udev-acl.obj: extras/udev-acl/udev-acl.c
	...
	$(AM_V_at)$(am__mv) extras/udev-acl/$(DEPDIR)/extras_udev_acl_udev_acl-udev-acl.Tpo extras/udev-acl/$(DEPDIR)/extras_udev_acl_udev_acl-udev-acl.Po
#	$(AM_V_CC) \
#	source='extras/udev-acl/udev-acl.c' object='extras/udev-acl/extras_udev_acl_udev_acl-udev-acl.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(extras_udev_acl_udev_acl_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o extras/udev-acl/extras_udev_acl_udev_acl-udev-acl.obj `if test -f 'extras/udev-acl/udev-acl.c'; then $(CYGPATH_W) 'extras/udev-acl/udev-acl.c'; else $(CYGPATH_W) '$(srcdir)/extras/udev-acl/udev-acl.c'; fi`
...
extras/usb-db/extras_usb_db_pci_db-usb-db.o: extras/usb-db/usb-db.c
	...
	$(AM_V_at)$(am__mv) extras/usb-db/$(DEPDIR)/extras_usb_db_pci_db-usb-db.Tpo extras/usb-db/$(DEPDIR)/extras_usb_db_pci_db-usb-db.Po
#	$(AM_V_CC) \
#	source='extras/usb-db/usb-db.c' object='extras/usb-db/extras_usb_db_pci_db-usb-db.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(extras_usb_db_pci_db_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o extras/usb-db/extras_usb_db_pci_db-usb-db.o `test -f 'extras/usb-db/usb-db.c' || echo '$(srcdir)/'`extras/usb-db/usb-db.c
...
extras/usb-db/extras_usb_db_pci_db-usb-db.obj: extras/usb-db/usb-db.c
	...
	$(AM_V_at)$(am__mv) extras/usb-db/$(DEPDIR)/extras_usb_db_pci_db-usb-db.Tpo extras/usb-db/$(DEPDIR)/extras_usb_db_pci_db-usb-db.Po
#	$(AM_V_CC) \
#	source='extras/usb-db/usb-db.c' object='extras/usb-db/extras_usb_db_pci_db-usb-db.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(extras_usb_db_pci_db_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o extras/usb-db/extras_usb_db_pci_db-usb-db.obj `if test -f 'extras/usb-db/usb-db.c'; then $(CYGPATH_W) 'extras/usb-db/usb-db.c'; else $(CYGPATH_W) '$(srcdir)/extras/usb-db/usb-db.c'; fi`
...
extras/usb-db/extras_usb_db_usb_db-usb-db.o: extras/usb-db/usb-db.c
	...
	$(AM_V_at)$(am__mv) extras/usb-db/$(DEPDIR)/extras_usb_db_usb_db-usb-db.Tpo extras/usb-db/$(DEPDIR)/extras_usb_db_usb_db-usb-db.Po
#	$(AM_V_CC) \
#	source='extras/usb-db/usb-db.c' object='extras/usb-db/extras_usb_db_usb_db-usb-db.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(extras_usb_db_usb_db_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o extras/usb-db/extras_usb_db_usb_db-usb-db.o `test -f 'extras/usb-db/usb-db.c' || echo '$(srcdir)/'`extras/usb-db/usb-db.c
...
extras/usb-db/extras_usb_db_usb_db-usb-db.obj: extras/usb-db/usb-db.c
	...
	$(AM_V_at)$(am__mv) extras/usb-db/$(DEPDIR)/extras_usb_db_usb_db-usb-db.Tpo extras/usb-db/$(DEPDIR)/extras_usb_db_usb_db-usb-db.Po
#	$(AM_V_CC) \
#	source='extras/usb-db/usb-db.c' object='extras/usb-db/extras_usb_db_usb_db-usb-db.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(extras_usb_db_usb_db_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o extras/usb-db/extras_usb_db_usb_db-usb-db.obj `if test -f 'extras/usb-db/usb-db.c'; then $(CYGPATH_W) 'extras/usb-db/usb-db.c'; else $(CYGPATH_W) '$(srcdir)/extras/usb-db/usb-db.c'; fi`
...
clean-libtool:
	...
	-rm -rf extras/modem-modeswitch/.libs extras/modem-modeswitch/_libs
...
install-dist_writing_udev_rulesDATA: $(dist_writing_udev_rules_DATA)
	@$(NORMAL_INSTALL)
	test -z "$(writing_udev_rulesdir)" || $(MKDIR_P) "$(DESTDIR)$(writing_udev_rulesdir)"
	@list='$(dist_writing_udev_rules_DATA)'; test -n "$(writing_udev_rulesdir)" || list=; \
	for p in $$list; do \
	  if test -f "$$p"; then d=; else d="$(srcdir)/"; fi; \
	  echo "$$d$$p"; \
	done | $(am__base_list) | \
	while read files; do \
	  echo " $(INSTALL_DATA) $$files '$(DESTDIR)$(writing_udev_rulesdir)'"; \
	  $(INSTALL_DATA) $$files "$(DESTDIR)$(writing_udev_rulesdir)" || exit $$?; \
	done

uninstall-dist_writing_udev_rulesDATA:
	@$(NORMAL_UNINSTALL)
	@list='$(dist_writing_udev_rules_DATA)'; test -n "$(writing_udev_rulesdir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	test -n "$$files" || exit 0; \
	echo " ( cd '$(DESTDIR)$(writing_udev_rulesdir)' && rm -f" $$files ")"; \
	cd "$(DESTDIR)$(writing_udev_rulesdir)" && rm -f $$files
...
installdirs-am:
	for dir in "$(DESTDIR)$(libdir)" "$(DESTDIR)$(libexecdir)" "$(DESTDIR)$(sbindir)" "$(DESTDIR)$(libexecdir)" "$(DESTDIR)$(man7dir)" "$(DESTDIR)$(man8dir)" "$(DESTDIR)$(docdir)" "$(DESTDIR)$(udevconfdir)" "$(DESTDIR)$(udevhomedir)" "$(DESTDIR)$(udevkeymapdir)" "$(DESTDIR)$(udevkeymapforcereldir)" "$(DESTDIR)$(udevrulesdir)" "$(DESTDIR)$(writing_udev_rulesdir)" "$(DESTDIR)$(girdir)" "$(DESTDIR)$(pkgconfigdir)" "$(DESTDIR)$(sharepkgconfigdir)" "$(DESTDIR)$(typelibsdir)" "$(DESTDIR)$(includedir)" "$(DESTDIR)$(libgudev_includedir)"; do \
...
distclean-generic:
	...
	-rm -f extras/modem-modeswitch/$(DEPDIR)/$(am__dirstamp)
	-rm -f extras/modem-modeswitch/$(am__dirstamp)
...
distclean: distclean-recursive
	...
	-rm -rf extras/ata_id/$(DEPDIR) extras/cdrom_id/$(DEPDIR) extras/collect/$(DEPDIR) extras/edd_id/$(DEPDIR) extras/floppy/$(DEPDIR) extras/fstab_import/$(DEPDIR) extras/gudev/$(DEPDIR) extras/hid2hci/$(DEPDIR) extras/keymap/$(DEPDIR) extras/modem-modeswitch/$(DEPDIR) extras/path_id/$(DEPDIR) extras/scsi_id/$(DEPDIR) extras/udev-acl/$(DEPDIR) extras/usb-db/$(DEPDIR) extras/usb_id/$(DEPDIR) extras/v4l_id/$(DEPDIR) libudev/$(DEPDIR) udev/$(DEPDIR)
	-rm -f Makefile
...
install-data-am: install-data-local install-dist_docDATA \
	install-dist_udevconfDATA install-dist_udevhomeDATA \
	install-dist_udevkeymapDATA \
	install-dist_udevkeymapforcerelDATA install-dist_udevrulesDATA \
	install-dist_writing_udev_rulesDATA install-girDATA \
	install-includeHEADERS install-libgudev_includeHEADERS \
	install-man install-pkgconfigDATA install-sharepkgconfigDATA \
...
uninstall-am: uninstall-dist_docDATA uninstall-dist_libexecSCRIPTS \
	...
	uninstall-dist_udevkeymapforcerelDATA \
	uninstall-dist_udevrulesDATA \
	uninstall-dist_writing_udev_rulesDATA uninstall-girDATA \
	...
	uninstall-sharepkgconfigDATA uninstall-typelibsDATA
	@$(NORMAL_INSTALL)
...
.PHONY: $(RECURSIVE_CLEAN_TARGETS) $(RECURSIVE_TARGETS) CTAGS GTAGS \
	...
	install-dist_udevkeymapforcerelDATA install-dist_udevrulesDATA \
	install-dist_writing_udev_rulesDATA install-dvi install-dvi-am \
	install-exec install-exec-am install-exec-hook install-girDATA \
	install-html install-html-am install-includeHEADERS \
	install-info install-info-am install-libLTLIBRARIES \
	install-libexecPROGRAMS install-libgudev_includeHEADERS \
	install-man install-man7 install-man8 install-pdf \
	install-pdf-am install-pkgconfigDATA install-ps install-ps-am \
	install-sbinPROGRAMS install-sharepkgconfigDATA install-strip \
	...
	uninstall-dist_libexecSCRIPTS uninstall-dist_udevconfDATA \
	uninstall-dist_udevhomeDATA uninstall-dist_udevkeymapDATA \
	uninstall-dist_udevkeymapforcerelDATA \
	uninstall-dist_udevrulesDATA \
	uninstall-dist_writing_udev_rulesDATA uninstall-girDATA \
	uninstall-hook uninstall-includeHEADERS \
	uninstall-libLTLIBRARIES uninstall-libexecPROGRAMS \
	uninstall-libgudev_includeHEADERS uninstall-man uninstall-man7 \
